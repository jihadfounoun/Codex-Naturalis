...
class DiagonalCornerCaseTest {
    ...
    void setUp() {
        ...
        player.getPlayerBoard().addToBoard(r6, new Coordinate(40, 40 - (4)));
        ResourceCard r7 = new ResourceCard("id", c, FUNGI);
        player.getPlayerBoard().addToBoard(r7, new Coordinate(40 + (1), 40 - (5)));
        ResourceCard r8 = new ResourceCard("id", c, FUNGI);
        player.getPlayerBoard().addToBoard(r8, new Coordinate(40 + (2), 40 - (6)));
        ...
        player.getPlayerBoard().addToBoard(a5, new Coordinate(40, 40 - (-4)));
        ResourceCard a6 = new ResourceCard("id", c, ANIMAL);
        player.getPlayerBoard().addToBoard(a6, new Coordinate(40 + (-1), 40 - (-5)));
        ResourceCard a7 = new ResourceCard("id", c, ANIMAL);
        player.getPlayerBoard().addToBoard(a7, new Coordinate(40 + (-2), 40 - (-6)));
        ...
        player.getPlayerBoard().addToBoard(i7, new Coordinate(40 + (6), 40 - (-6)));
        ResourceCard i8 = new ResourceCard("id", c, INSECT);
        player.getPlayerBoard().addToBoard(i8, new Coordinate(40 + (7), 40 - (-7)));
        ResourceCard i9 = new ResourceCard("id", c, INSECT);
        player.getPlayerBoard().addToBoard(i9, new Coordinate(40 + (8), 40 - (-8)));
        ...
        player.getPlayerBoard().addToBoard(p6, new Coordinate(40 + (-6), 40 - (6)));
        ResourceCard p7 = new ResourceCard("id", c, PLANT);
        player.getPlayerBoard().addToBoard(p7, new Coordinate(40 + (-7), 40 - (7)));
        ResourceCard p8 = new ResourceCard("id", c, PLANT);
        player.getPlayerBoard().addToBoard(p8, new Coordinate(40 + (-8), 40 - (8)));
    }

    @Test
    void testUpdate() {
        int[] expected = {4, 4, 4, 4, 3, 3, 3, 3};
