...
public class ResourceCardTest4 {
    private ResourceCard resourceCard;

    @BeforeEach
    void setUp() {
        resourceCard= new ResourceCard("1",
                new Corner[]{new ResCorner(Resource.INSECT),new Corner(false, true), new Corner(true, false), new Corner(true, false)},
                Resource.INSECT);
    }

    @Test
    void testBackResource(){
        Resource expectedValue = Resource.INSECT;
