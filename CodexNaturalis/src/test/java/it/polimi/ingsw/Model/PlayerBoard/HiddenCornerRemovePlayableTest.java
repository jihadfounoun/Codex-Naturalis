...
class HiddenCornerRemovePlayableTest {
    ...
    void setUp() throws IOException {
        ...
        frontCorners3[2] = new Corner(false, true);
        ...
        playerBoard.addToBoard(playedCard2, new Coordinate(39, 41));
    }
    ...
    void testUpdate() {
        ...
        expectedRes.add(new Coordinate(38, 42));
