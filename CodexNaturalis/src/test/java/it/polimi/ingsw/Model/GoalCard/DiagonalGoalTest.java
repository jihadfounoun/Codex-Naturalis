...
class DiagonalGoalTest {
    private DiagonalGoal diagonalGoal;
    ...
    void setUp() throws IOException {
        diagonalGoal = new DiagonalGoal("89", Resource.ANIMAL, true);
        ...
        played3 = new ResourceCard("26", frontCorners, Resource.ANIMAL);
        expected = 2;
    }
    ...
    void testUpdate() {
        ...
        player.cardSetUp(played1, false, new Coordinate(41, 39));
        player.cardSetUp(played2, false, new Coordinate(42, 38));
        player.cardSetUp(played3, false, new Coordinate(43, 37));
        assertEquals(expected, diagonalGoal.checkPoints(player.getPlayerBoard()));
    }
}