...
public class MixedDispositionGoalMultipleDiagonals {
    Player player;
    ...
    void setUp() {
        ...
        player.getPlayerBoard().addToBoard(r7, new Coordinate(40, 40 - (6)));
        ...
        player.getPlayerBoard().addToBoard(a6, new Coordinate(40 + (2), 40 - (2)));
        ResourceCard a7 = new ResourceCard("id", c, ANIMAL);
        player.getPlayerBoard().addToBoard(a7, new Coordinate(40 + (3), 40 - (3)));
        ...
        player.getPlayerBoard().addToBoard(i7, new Coordinate(40 + (5), 40 - (-3)));
        ResourceCard i8 = new ResourceCard("id", c, INSECT);
        player.getPlayerBoard().addToBoard(i8, new Coordinate(40 + (6), 40 - (-4)));
        ...
        player.getPlayerBoard().addToBoard(p6, new Coordinate(40 + (-5), 40 - (7)));
        ResourceCard p7 = new ResourceCard("id", c, PLANT);
        player.getPlayerBoard().addToBoard(p7, new Coordinate(40 + (-4), 40 - (6)));
    }
